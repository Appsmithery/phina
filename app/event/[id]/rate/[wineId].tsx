...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, Modal, Pressable, TextInput } from "react-native";
      ...
      <View style={styles.headerRow}>
        ...
        {eventId && userId && (
          <TouchableOpacity onPress={toggleFavorite} style={styles.favoriteBtn} hitSlop={12}>
            <Ionicons name={isFavorite ? "star" : "star-outline"} size={28} color={isFavorite ? theme.primary : theme.textMuted} />
          </TouchableOpacity>
        )}
      </View>
      {!member ? (
            ...
            <Pressable style={styles.modalOverlay} onPress={() => setSweetnessModalVisible(false)}>
              <View style={[styles.modalContent, { backgroundColor: theme.surface, borderColor: theme.border }]}>
                ...
                {SWEETNESS_OPTIONS.map((opt) => (
                  <TouchableOpacity
                    key={opt.value}
                    style={[styles.modalOption, sweetness === opt.value && { backgroundColor: theme.primary + "20" }]}
                    onPress={() => {
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: "700", flex: 1, fontFamily: "PlayfairDisplay_700Bold" },
  ...
  metaLabel: { fontSize: 12, color: "inherit", fontFamily: "Montserrat_400Regular" },
  helperText: { fontSize: 11, lineHeight: 16, marginBottom: 10, paddingHorizontal: 2, fontFamily: "Montserrat_300Light" },
  dropdown: { borderWidth: 1, borderRadius: 12, paddingVertical: 12, paddingHorizontal: 16, marginBottom: 16 },
  dropdownText: { fontSize: 16, fontFamily: "Montserrat_400Regular" },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "center", padding: 24 },
  modalContent: { borderWidth: 1, borderRadius: 14, padding: 16 },
  modalTitle: { fontSize: 16, fontWeight: "600", marginBottom: 12, fontFamily: "Montserrat_600SemiBold" },
  modalOption: { paddingVertical: 12, paddingHorizontal: 16, borderRadius: 10, marginBottom: 4 },
  modalOptionText: { fontSize: 16, fontFamily: "Montserrat_400Regular" },
  sliderRow: { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 16 },
  slider: { flex: 1, height: 40 },
  sliderValue: { fontSize: 14, minWidth: 36, fontFamily: "Montserrat_400Regular" },
  confidenceNoneBtn: { paddingVertical: 8, paddingHorizontal: 12 },
  confidenceNoneText: { fontSize: 14, fontFamily: "Montserrat_400Regular" },
  hint: { textAlign: "center", fontSize: 16, fontFamily: "Montserrat_400Regular" },
  ...
  noteInput: { borderWidth: 1, borderRadius: 12, padding: 12, fontSize: 15, fontFamily: "Montserrat_400Regular", minHeight: 56, marginBottom: 16, textAlignVertical: "top" },
});
